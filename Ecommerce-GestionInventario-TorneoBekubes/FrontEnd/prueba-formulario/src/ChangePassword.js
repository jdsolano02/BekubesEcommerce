...
const ChangePassword = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch("http://localhost/Ecommerce-GestionInventario-TorneoBekubes/BackEnd/reset-password.php", {
        method: "POST",
      ...
      <div className="card shadow-lg p-5 rubik-card" style={{ width: '450px', borderRadius: '15px' }}>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="d-flex justify-content-center">
            <button type="submit" className="btn rubik-btn btn-block">Cambiar Contraseña</button>
          </div>
        </form>
      </div>
    </div>
