      ...
      >
        ...
        <div className="mb-4">
          ...
          <div className="d-flex flex-wrap gap-2 mb-4">
            <Button
              style={{backgroundColor: filtroEstado === "todos" ? "#ff6347" : "#ff7f50", color:"white"}}
            ...
            <Button
            style={{backgroundColor: filtroEstado === "Procesando" ? "#ff6347" : "#ff7f50", color:"white"}}
              variant={
                filtroEstado === "Procesando" ? "primary" : "outline-primary"
              }
            ...
            <Button
              style={{backgroundColor: filtroEstado === "Enviado" ? "#ff6347" : "#ff7f50", color:"white"}}
              variant={
                filtroEstado === "Enviado" ? "primary" : "outline-primary"
              }
            ...
            <Button
              style={{backgroundColor: filtroEstado === "Entregado" ? "#ff6347" : "#ff7f50", color:"white"}}
              variant={
                filtroEstado === "Entregado" ? "primary" : "outline-primary"
              }
                    ...
                    <tr key={pedido.ID_Pedido}>
                      ...
                      <td className="d-flex gap-2">
                        ...
                        <Button
                          ...
                          size="sm"
                          onClick={() =>
                            navigate(`/factura/${pedido.ID_Pedido}`)
                          }
